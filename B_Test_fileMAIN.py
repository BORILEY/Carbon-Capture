# This should work just formated version of automatedSystem
import serial
import time
...
def main():
    ...
    while True :
        ...
        valueSensor1=SensorData[0] #read first value
        valueSensor2=SensorData[1] #read second value
        currentTime=SensorData[2]
...
def readDataPacket():
    while(arduinoData.inWaiting()==0): #creates a while loop that continues until there is data avalible to read from sensor1
        pass
    ...
    while(arduinoData2.inWaiting()==0): #creates a while loop that continues until there is data avalible to read from sensor2
        pass
