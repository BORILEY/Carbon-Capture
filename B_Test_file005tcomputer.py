#Brandon Riley
# attempt to incorperat graph2 and csv file with subprocess file
import serial
import time
...
os.environ['x_vals'] = ""
os.environ['sensorValueInlet_data'] = ""
os.environ['sensorValueOutlet_data'] = ""
...
def main():
    ...
    while True:
        ...
        os.environ['x_vals'] = current_time
        os.environ['sensorValueInlet_data'] = value_sensor1
        os.environ['sensorValueOutlet_data'] = value_sensor2
        test005pt2.process_data()
        ...
        if value_sensor2 > trigger:
            test005pt2.write_adsorption_Data_csv()
            print(value_sensor1, value_sensor2, current_time)
            desorption()
...
def run_graph_script():
    subprocess.run(['python', 'test005pt2.py'])   
