#Brandon Riley
# attempt to incorperat graph2 and csv file
import serial
import time
...
def update_plot(frame):
    sensor_data = read_data_packet()
    value_sensor1, value_sensor2, current_time = sensor_data
    process_data(value_sensor1, value_sensor2, current_time)
    plt.cla()
...
def process_data(dataInlet, dataOutlet, time):
    x_vals.append(time)
    sensorValueInlet_data.append(dataInlet)
    sensorValueOulet_data.append(dataOutlet)
